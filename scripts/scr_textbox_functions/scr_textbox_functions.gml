function scr_set_defaults_for_text(){
	...
	snd[page_number] = snd_menu_switch;
}
...
//get character info
	if argument_count > 1 {
		...
		case "Character":
			...
			txtb_spr[page_number] = spr_textbox_org; 
			snd[page_number] = snd_txt;
			break;
			
		case "Character uwu":
			speaker_sprite[page_number] = spr_player_spk_uwu;
			txtb_spr[page_number] = spr_textbox_org;
			snd[page_number] = snd_txt;
			break;	
		...
		//Alfie	
		case "Kris Character":
			speaker_sprite[page_number] = spr_kris_spk; 
			txtb_spr[page_number] = spr_textbox_alfie;
			speaker_side[page_number] = -1;
			snd[page_number] = snd_lightswitch;
			break;		
