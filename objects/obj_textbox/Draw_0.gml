...
if speaker_sprite[page] != noone
	...
	//draw the speaker
	draw_sprite_ext(txtb_spr[page], txtb_img, textbox_x + portrait_x_offset[page], textbox_y, 3, 3, 0, c_white, 1)
	draw_sprite_ext(sprite_index, image_index, _speaker_x+2.3, textbox_y+6, 0.9, 0.9, 0, c_white, 1); 
	}
...
if draw_char == text_length[page] && page == page_number - 1
	...
	for (var op = 0; op < option_number; op++)
		...
		//the option text
		draw_text(_txtb_x + 16 + _op_bord, _txtb_y - _op_space*option_number + _op_space*op + 0, option[op]); //0 was 2
...
for(var c = 0; c < draw_char; c++)
	...
	//the text
	draw_text_color( char_x[c, page] + _shake_x, char_y[c, page] + _float_y + _shake_x, char[c, page], col_1[c, page], col_2[c, page], col_3[c, page], col_4[c, page], 1);
	}
